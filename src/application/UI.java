...
public class UI {
	...
	public static void printBoard(Piece[][] pieces, Board board) {
		for (int i=0; i<pieces.length; i++) {
			...
			for (int j=0; j<pieces.length; j++) {
				printPiece(pieces[i][j], false, i, j, board);
			}
			System.out.println();
		}
	...
	public static void printBoard(Piece[][] pieces, boolean[][] possibleMoves, Board board) {
		for (int i=0; i<pieces.length; i++) {
			System.out.print((8-i) + " ");
			for (int j=0; j<pieces.length; j++) {
				printPiece(pieces[i][j], possibleMoves[i][j], i, j, board);
			}
			System.out.println();
		}
